...
class Math_QuaternionTest extends PHPUnit_Framework_TestCase {
	...
	public function testChauWenTsengData() {
		...
		ob_start();
		?>
* Test 1: q0 = [ 1 1 0 0 ] q1 = [ 1 0 1 0 ] q2 = q0 + q1 = [ 2 1 1 0 ]
q9 = q0 * q1 = [ 1 1 1 1 ] q9 = -q1 = [ -1 -0 -1 -0 ] * Test 2: q0 = [ 1
0.5 0 0 ] q1 = [ 1 -1 0 0 ] q2 = [ 0 0 1 0 ] q3 = [ 0 0 0 1 ] q3 = -q3 =
[ -0 -0 -0 -1 ] q6 = q2 + q3 = [ 0 0 1 -1 ] q4 = q0 * q1 = [ 1.5 -0.5 0
0 ] q4 = q4 * q0 = [ 1.75 0.25 0 0 ] * Test 3: q1 = [ 1 2 3 1 ] q2 = [ 2
1 0 1 ] q5 = [ 1 2 0 3 ] q4 = q1 * q2 = [ -1 8 5 0 ] q3 = q1 * q5 = [ -6
13 -1 -2 ] q8 = q1 + q3 = [ -5 15 2 -1 ] q8 = -q8 = [ 5 -15 -2 1 ] q8 =
-q8 = [ -5 15 2 -1 ] * Test 4: q0 = [ 1 1 1 1 ] q1 = [ 4 3 2 1 ] q2 =
-q0 = [ -1 -1 -1 -1 ] q3 = q1 * q2 = [ 2 -8 -4 -6 ] q4 = q2 * q3 = [ -20
8 4 0 ] q5 = q3 * q4 = [ 40 200 40 120 ] q6 = q4 + q5 = [ 20 208 44 120
] q7 = -q6 = [ -20 -208 -44 -120 ] q8 = q5 + q7 = [ 20 -8 -4 0 ] q9 = q7
+ q8 = [ 0 -216 -48 -120 ] * Test 5: q0 = [ 1 2 1 -1 ] q1 = [ 0 0 0 0 ]
q2 = q0 + q1 = [ 1 2 1 -1 ] q1 = q2 * q0 = [ -5 4 2 -2 ] q2 = negate(a)
= [ -1 -2 -1 1 ] q1 = q2 * q0 = [ 5 -4 -2 2 ] q3 = [ -1 1 0 0 ] q4 = [ 1
-1 0 0 ] q5 = q3 * q4 = [ 0 2 0 0 ] q5 = -q5 = [ -0 -2 -0 -0 ] q5 = q5 *
q5 = [ -4 0 0 0 ] q5 = q5 * q5 = [ 16 0 0 0 ] q5 = q5 * q5 = [ 256 0 0 0
] * Test 6: q8 = [ 1.22 -1.84 -0.32 -3.21 ] q7 = [ -0.82 -0.51 1.51 1.13
] q3 = [ 1.28 -3.52 -3.14 -4.84 ] q2 = [ -0.74 -0.25 -4.39 -8.22 ] q5 =
[ -2.28 -1.19 2.84 -2.34 ] q1 = [ 1.1 -0.58 -9.53 7.27 ] q6 = [ -4.63
-3.54 8.94 -2.28 ] q9 = [ -0.13 -0.32 -1.04 8.49 ] q4 = [ -8.39 -9.27
8.01 4.03 ] q0 = [ -7.43 -0.14 -5.24 -7.01 ] q0 = q0 * q1 = [ -7.2287
-100.7447 70.1275 -63.4321 ] q1 = q1 * q2 = [ 16.9637 110.4061 -4.3619
-14.2581 ] q8 = q9 * q8 = [ 26.1727 5.904 -17.876 8.9639 ] q6 = q7 * q6
= [ -8.9318 -8.2809 -19.4851 -2.5763 ]
<?php
...
$this->assertSame($expected, $result);
	...
	public function test() {
		...
		ob_start();
		?>
a: 2 + 4i + 2j + -0.5k b: 1 + 2i + 3j + 0.5k a': 2 + -4i + -2j + 0.5k
b': 1 + -2i + -3j + -0.5k length(a): 4.9244289008981 length2(a): 24.25
real(a): 2 imag(a): Array ( [i] => 4 [j] => 2 [k] => -0.5 ) a and neg(a)
are different Neg(a) is -2 + -4i + -2j + 0.5k Conj(a) is 2 + -4i + -2j +
0.5k Inv(a) is 0.40613846605345 + -0.8122769321069i + -0.40613846605345j
+ 0.10153461651336k MultReal(a, 1.23) is 2.46 + 4.92i + 2.46j + -0.615k
==== a*b: -11.75 + 10.5i + 5j + 8.5k b*a: -11.75 + 5.5i + 11j + -7.5k
a*a': 24.25 + 0i + 0j + 0k length(a*a'): 24.25 a+b: 3 + 6i + 5j + 0k
a-b: 1 + 2i + -1j + -1k b-a: -1 + -2i + 1j + 1k b-a': -1 + 6i + 5j + 0k
b'-a: -1 + -6i + -5j + 0k b'-a': -1 + 2i + -1j + -1k a/b:
4.1722769247549 + 0.66226617853252i + -1.8543452998911j +
1.7218920641846k b/a: 3.1983404201709 + -0.50767308256681i +
1.4214846311871j + -1.3199500146737k
<?php
$expected = ob_get_clean();
